...
int main() {
    ...
    std::cout<<acc4;
    // struct tm start = {0}; start.tm_year = 119; start.tm_mday = 1; start.tm_mon=0;
    // struct tm end = {0}; end.tm_year = 119; end.tm_mday = 31; end.tm_hour = 23; end.tm_min = 59; end.tm_sec = 59; end.tm_mon = 0;

    // for (int j=0; j < 12; j++){
        

    //     std::cout << "check ------ " << "start.tm_mon: " << start.tm_mon << ", end.tm_mon: " << end.tm_mon ;
    //     std::cout <<", acc1 balance is " << acc1.balance(mktime(&start), mktime(&end)) << "\n";
    //     start.tm_mon++; 
    //     end.tm_mon++;
    // }
